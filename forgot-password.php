...
function sendEmail($email, $subject, $message)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'mahasiswapentingumc@gmail.com';
        $mail ->Password = 'njewgxfxgotqgzdh';
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;

        // Pengaturan email
        $mail->setFrom('mahasiswapentingumc@gmail.com', 'Mahasiswa Penting'); // Ganti dengan alamat email dan nama pengirim
...
if (isset($_POST['reset'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $subject = "Reset Kata Sandi - Mahasiswa Penting";
        ...
        <html>
          ...
          <body>
            <div class='container'>
              ...
              <p>Halo &#x1F44B;,</p>
              <p>Saya Admin Mahasiswa Penting dari Sistem Pakar Mahasiswa Penting Peduli Stunting . Anda telah meminta untuk melakukan reset kata sandi. Silakan klik tautan berikut untuk mereset kata sandi Anda:</p>
              <p><a href='$resetLink'>Reset Kata Sandi</a></p>
              <p>Jika Anda tidak meminta reset kata sandi, Anda dapat mengabaikan email ini.</p>
              <p class='footer'>Salam Hangat &#x1F60A;,<br /><br /><br />Mahasiswa Penting</p>
            </div>
          </body>
        </html>
        ";
...
<body class="bg-gradient-info d-flex align-items-center justify-content-center min-vh-100 user-select-none">
                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" onsubmit="return validateForm();" action="">
                                        ...
                                        <button name="reset" class="btn btn-warning btn-user btn-block" type="submit">
                                            Reset kata sandi
                                        </button>
